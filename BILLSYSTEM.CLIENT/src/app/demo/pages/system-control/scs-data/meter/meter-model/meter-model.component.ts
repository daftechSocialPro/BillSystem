...
import { IMeterModelGetDto } from 'src/models/system-control/IMeterModelDto';
...
export class MeterModelComponent  implements OnInit {
  ...
  getMeterModels(){
    ...
    this.controlService.getMeterModel().subscribe({
      next:(res)=>{
  ...
  removeMeterModel(MeterModelId:string) {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.controlService.deleteMeterModel(MeterModelId).subscribe({
          next: (res) => {
  ...
  updateMeterModel(MeterModel:IMeterModelGetDto){
