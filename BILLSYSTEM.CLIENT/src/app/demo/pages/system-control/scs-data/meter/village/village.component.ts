...
import { IVillageGetDto } from 'src/models/system-control/IVillageDto';
...
export class VillageComponent implements OnInit {
  ...
  getVillages(){
    ...
    this.controlService.getVillage().subscribe({
      next:(res)=>{
        this.Villages = res 
      }
    })
  ...
  removeVillage(VillageId:string) {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.controlService.deleteVillage(VillageId).subscribe({
          next: (res) => {
  ...
  updateVillage(Village:IVillageGetDto){
