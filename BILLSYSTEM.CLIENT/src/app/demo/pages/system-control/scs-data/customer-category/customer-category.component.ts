...
import { ICustomerCategoryGetDto } from 'src/models/system-control/ICustomerCategoryDto';
...
export class CustomerCategoryComponent implements OnInit {
  ...
  CustomerCategories:ICustomerCategoryGetDto[]
  ngOnInit(): void {
  ...
  removeCustomerCategories(CustomerCategoriesId:string) {
  ...
  updateCustomerCategories(CustomerCategories:ICustomerCategoryGetDto){
