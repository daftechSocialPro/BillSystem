...
namespace IntegratedDigitalAPI.Controllers.SytemControl
{
    ...
    public class CustomerCategoryController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(CustomerCategoryGetDto), (int)HttpStatusCode.OK)]
        ...
        public async Task<IActionResult> AddCustomerCategory(CustomerCategoryPostDto addCustomerCategory)
        {
        ...
        [HttpPut]
        [ProducesResponseType(typeof(ResponseMessage), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> UpdateCustomerCategory(CustomerCategoryGetDto updateCustomerCategory)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpDelete]
        [ProducesResponseType(typeof(ResponseMessage), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> DeleteCustomerCategory(Guid CustomerCategoryId)
        {
            if (ModelState.IsValid)
            {
